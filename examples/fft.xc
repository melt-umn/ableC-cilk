 ...
 */
cilk static void compute_w_coefficients(int n, int a, int b, COMPLEX * W);
cilk static void compute_w_coefficients(int n, int a, int b, COMPLEX * W)
{
...
cilk static void unshuffle(int a, int b,
...
cilk static void fft_twiddle_gen1(COMPLEX * in, COMPLEX * out,
...
cilk static void fft_twiddle_gen(int i, int i1,
...
cilk static void fft_twiddle_2(int a, int b, COMPLEX * in, COMPLEX * out,
...
cilk static void fft_unshuffle_2(int a, int b, COMPLEX * in, COMPLEX * out, int m);
cilk static void fft_unshuffle_2(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
...
cilk static void fft_twiddle_4(int a, int b, COMPLEX * in, COMPLEX * out,
			       COMPLEX * W, int nW, int nWdn, int m);
cilk static void fft_twiddle_4(int a, int b, COMPLEX * in, COMPLEX * out,
			       COMPLEX * W, int nW, int nWdn, int m)
{
...
cilk static void fft_unshuffle_4(int a, int b, COMPLEX * in, COMPLEX * out, int m);
cilk static void fft_unshuffle_4(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
...
cilk static void fft_twiddle_8(int a, int b, COMPLEX * in, COMPLEX * out,
			       COMPLEX * W, int nW, int nWdn, int m);
cilk static void fft_twiddle_8(int a, int b, COMPLEX * in, COMPLEX * out,
			       COMPLEX * W, int nW, int nWdn, int m)
{
...
cilk static void fft_unshuffle_8(int a, int b, COMPLEX * in, COMPLEX * out, int m);
cilk static void fft_unshuffle_8(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
...
cilk static void fft_twiddle_16(int a, int b, COMPLEX * in, COMPLEX * out,
				COMPLEX * W, int nW, int nWdn, int m);
cilk static void fft_twiddle_16(int a, int b, COMPLEX * in, COMPLEX * out,
				COMPLEX * W, int nW, int nWdn, int m)
{
...
cilk static void fft_unshuffle_16(int a, int b, COMPLEX * in, COMPLEX * out, int m);
cilk static void fft_unshuffle_16(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
...
cilk static void fft_twiddle_32(int a, int b, COMPLEX * in, COMPLEX * out,
				COMPLEX * W, int nW, int nWdn, int m);
cilk static void fft_twiddle_32(int a, int b, COMPLEX * in, COMPLEX * out,
				COMPLEX * W, int nW, int nWdn, int m)
{
...
cilk static void fft_unshuffle_32(int a, int b, COMPLEX * in, COMPLEX * out, int m);
cilk static void fft_unshuffle_32(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
 ...
 *
 */
cilk static void fft_aux(int n, COMPLEX * in, COMPLEX * out, int *factors,
			 COMPLEX * W, int nW);
cilk static void fft_aux(int n, COMPLEX * in, COMPLEX * out, int *factors,
			 COMPLEX * W, int nW)
{
...
//     int factors[40];		/* allows FFTs up to at least 3^40 */
     int *factors = malloc(40 * sizeof(int));
     int *p = factors;
     int l = n;
     int r;
     COMPLEX *W;
